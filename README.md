...
### Release 3:  Declare Belongs To Associations
...
### Release 4:  Explore Methods Generated by Belong To
We've briefly looked at the methods generated when we declare a belongs to association.  We need practice using them.  Let's take some time to explore these methods in the console.  Pull ratings from the database or create new ones and explore the getter and setter methods.  Reassign the dog to which ratings belong.  Build or create new dogs for ratings.  Look at the SQL generated when we run these methods.  In general, build familiarity with these methods before moving on.
